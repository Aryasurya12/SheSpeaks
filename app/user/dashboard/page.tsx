        ...
        <div className="relative p-12 rounded-[3.5rem] bg-[#0B0120] border border-white/5 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-8 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/20 border border-primary/30 text-primary text-[10px] font-black uppercase tracking-[0.2em] italic">
                <ShieldCheck className="w-3 h-3" /> Secure Identity Active
              </div>
              <h1 className="text-4xl md:text-6xl font-black tracking-tighter leading-[1.1]">
                Hello, <span className="text-gradient">
                  {user?.isAnonymous ? user?.id : user?.fullName?.split(" ")[0] || "User"}
                </span>
              </h1>
